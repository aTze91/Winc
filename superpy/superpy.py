...
def main():
    ...
    if args.buy:
        if args.p_name and args.exp_date and args.buy_price and args.sell_price and args.quantity:
            inventory.buy(args.p_name, args.exp_date, args.buy_price, args.sell_price, args.quantity)
        else:
